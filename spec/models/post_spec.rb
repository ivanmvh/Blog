...
describe Post, type: :model do
  ...
  it '1-title should be present' do
    subject.title = nil
    expect(subject).to_not be_valid
  end

  it '2-title should not exceed 250 characters' do
    long_title = 'A' * 260
    subject.title = long_title
    expect(subject).to_not be_valid
  end

  it '3-comments_counter should be positive' do
    subject.comments_counter = -1
    expect(subject).to_not be_valid
  end

  it '4-likes_counter should be positive' do
    subject.likes_counter = -1
    expect(subject).to_not be_valid
  end

  it '5-shows at 5 most recent comments' do
    subject.comments = [
  ...
  it '6-check the content of most recent comments' do
    subject.comments = [
      Comment.new(post: subject, author: subject.author, text: 'text-comment-1'),
      Comment.new(post: subject, author: subject.author, text: 'text-comment-2'),
      Comment.new(post: subject, author: subject.author, text: 'text-comment-3'),
  ...
  it '7-should increment post counter for the author' do
